...
![Activity diagram for service manager addsvc command](images/ListTrackerClassDiagram.png)
...
![Sequence diagram for addsvc command](images/ListTrackerClassDiagram.png)
