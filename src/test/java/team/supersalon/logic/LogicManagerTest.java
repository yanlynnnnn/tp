package team.supersalon.logic;

import static org.junit.jupiter.api.Assertions.assertEquals;
import static team.supersalon.commons.core.Messages.MESSAGE_INVALID_CLIENT_DISPLAYED_INDEX;
...
import team.supersalon.logic.commands.CommandResult;
...
import team.supersalon.storage.JsonAddressBookStorage;
import team.supersalon.storage.JsonUserPrefsStorage;
import team.supersalon.storage.StorageManager;
...
public class LogicManagerTest {
    ...
    public void getFilteredClientList_modifyList_throwsUnsupportedOperationException() {
        Assert.assertThrows(UnsupportedOperationException.class, () -> logic.getFilteredClientList().remove(0));
    }
