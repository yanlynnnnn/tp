 ...
 */
public class AppointmentSlotRed extends SlotContainer {

    private static final String FXML = "schedulepanel/AppointmentSlotRed.fxml";
     ...
     */
    public AppointmentSlotRed(Appointment appointment) {
        super(FXML);
